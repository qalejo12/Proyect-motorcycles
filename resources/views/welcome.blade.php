    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a><x-application-mark class="block h-9 w-auto" /></a>
                ...
                <div class="container" style="padding: 34px">
                    ...
                    <div class="container">
                        <div class="container">
                            <h1 class="alert alert-dark text-left">Categories List</h1>
                        </div>
                        <h1>Categories</h1>
                        <div class="row row-cols-1 row-cols-md-2 g-4">
                            @foreach($categories as $category)
                                <div class="col p-4 my-3">
                                    <div class="card">
                                        <div class="card-body">
                    ...
                    <div class="container">
                            <div class="container">
                                <h1 class="alert alert-dark text-left">Bikes List</h1>
                            </div>

                            <h2 style="padding: 2% 0;">Motorcycles </h2>
